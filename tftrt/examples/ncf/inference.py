...
def input_data(use_synthetic=True,
    ...
    if use_synthetic:
        ...
        if os.path.exists(data_dir):
             ...
             #movielens.download("ml-20m", data_dir)
        
        
        #with open(data_dir + 'ratings.csv') as csv_file:
        #    ratings_reader = csv.reader(csv_file, delimiter=',')
        #with open(data_dir + 'movies.csv') as csv_file:
        #    movies_reader = csv.reader(csv_file, delimiter=',')
        #with open(data_dir + 'users.csv') as csv_file:
...
if __name__ == '__main__':
    ...
    parse.add_argument('--use_synthetic', type=str, default=None)
    ...
    parser.add_argument('--batch_size', type=int, default=8,
            help='Batch size')
    #parser.add_argument('--model_dtype', , default=tf.float32) 
